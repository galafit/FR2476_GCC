...
//    uchar* acc_data = adc_get_data();
    ...
    /*
    //acc data
    fill_buffer[batch_size - 9] = acc_data[10];
    fill_buffer[batch_size - 8] = acc_data[11];
    fill_buffer[batch_size - 7] = acc_data[8];
    fill_buffer[batch_size - 6] = acc_data[9];
    fill_buffer[batch_size - 5] = acc_data[6];
    fill_buffer[batch_size - 4] = acc_data[7];
    */
    //gyr data
    fill_buffer[batch_size - 9] = acc_data[4];
    fill_buffer[batch_size - 8] = acc_data[5];
    fill_buffer[batch_size - 7] = acc_data[2];
    fill_buffer[batch_size - 6] = acc_data[3];
    fill_buffer[batch_size - 5] = acc_data[0];
    fill_buffer[batch_size - 4] = acc_data[1];
    //Adding battery info
