...
#define SELECT_ADS() (P4OUT &= ~CS_BIT)   //Selecting ADS
#define DESELECT_ADS() (P4OUT |= CS_BIT)   //deselecting ads
...
static uchar test_reg_values[] = {0x02, //reg 0x01  Set sampling ratio to 500 SPS
                                 ...
                                 // 0x05,  //reg 0x04 Set Channel 1 to test
                                  0x10,  //reg 0x04 Set Channel 1 to input and set amplification to 1
